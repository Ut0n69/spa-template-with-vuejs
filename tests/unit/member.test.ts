...
import { Types, FetchMember } from '@/store/Modules/member/types'
...
describe('mutations', () => {
  describe('memberList', () => {
    test('get member list', () => {
      ...
      mutations[Types.FETCH_MEMBER](state, new FetchMember(testData))
      expect(state.list[0]).toEqual(testData)
    })
  })
})
